...
import org.opencypher.gremlin.translation.ir.builder.{IRGremlinBindings, IRGremlinSteps, IRGremlinTokens}
...
class CypherAst private (
  ...
  private def translate(
    ...
    val dsl = new TheTranslator[Seq[GremlinStep], IRGremlinTokens](
      new IRGremlinSteps,
      new IRGremlinTokens,
